export const PUBLIC_PRODUCT_CARD_FIELDS =
  "id,title,subtitle,handle,thumbnail,*variants.calculated_price,+variants.inventory_quantity,+variants.manage_inventory,+variants.allow_backorder,variants.sku,variants.barcode,variants.ean,variants.upc,*collection,*categories,*images,*variants.options"
...
export const PUBLIC_HOME_PRODUCT_FIELDS =
  "id,title,handle,thumbnail,variants.sku,*collection,*variants.calculated_price,+variants.inventory_quantity,+variants.manage_inventory,+variants.allow_backorder,categories.id,categories.handle,images.url"
