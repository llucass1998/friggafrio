        ...
        <div className="grid lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)]">
          ...
          <form onSubmit={submit} noValidate className="p-7 sm:p-9 lg:p-11">
            ...
            <label className="mt-5 flex cursor-pointer items-start gap-3 text-sm leading-6 text-[var(--color-text-muted)]">
              ...
              <span>Quero receber novidades, conteúdos e ofertas da FriggaFrio por e-mail. Li e concordo com a <a href="/br/privacidade" className="font-semibold text-[var(--color-primary)] underline underline-offset-2">Política de Privacidade</a>. Posso cancelar a qualquer momento.</span>
            </label>
