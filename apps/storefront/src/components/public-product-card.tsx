...
export function PublicProductCard({ product, compact = false }: PublicProductCardProps) {
  ...
  return (
    <article data-testid="public-product-card" className="group relative flex h-full w-full min-w-0 flex-col overflow-hidden rounded-[var(--radius-card)] border border-[var(--color-border)] bg-white transition-[box-shadow,border-color] duration-[var(--motion-duration-card)] ease-[var(--motion-ease-standard)] hover:border-[var(--color-primary)] hover:shadow-md focus-within:ring-2 focus-within:ring-[var(--color-primary)]">
      <FavoriteButton
