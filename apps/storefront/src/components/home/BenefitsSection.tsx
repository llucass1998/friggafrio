      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group flex flex-col items-start gap-4 rounded-[var(--radius-card-lg)] border border-[var(--color-border)] bg-white p-6 transition-colors duration-200 hover:bg-[#E6F2FC] sm:p-8"
            >
              ...
              <div>
                <h3 className="font-bold text-lg text-[var(--color-navy)] mb-2 tracking-tight group-hover:text-[var(--color-primary)] transition-colors duration-200">
                  {benefit.title}
                </h3>
